                              ...
                              builder: (context, value, child) {
                                return AspectRatio(
                                  ...
                                  child: Container(
                                    ...
                                    child: CustomPaint(
                                        painter:
                                            BorderPainter(currentState: value),
                                        child: Container(
                                            alignment: Alignment.center,
...
class BorderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect rect = const Offset(0, -4) & Size(size.width, size.width);
...
class DiagramPainter extends CustomPainter {
  ...
  DiagramPainter(
      {required this.currentState, required this.active, required this.value});
    ...
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(
              ...
              size.height * (1 - value),
              15,
              size.height * value / 1 * currentState,
            ),
      ...
      canvas.drawRRect(
          RRect.fromRectAndRadius(
              Rect.fromLTWH(
                ...
                size.height * (1 - value),
                15,
                size.height * value / 1 * active * currentState,
              ),
              Radius.circular(50.0)),
          completed);
  }
